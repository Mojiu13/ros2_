...
|---|---|---|---:|---|---|
| [ENV-01](modules/ENV-01.md) | Docker 化 ROS2 Jazzy 工程环境与可复现工作区 | Phase 0 | P0 | 基本 Linux 使用；C++ / Python 基础；不要求 ROS 或 Docker 深入知识 | L |
...
- Phase 0 Gate：Dockerized ROS 环境可删除、重建、恢复；双语言包与配置可运行；ROS 容器网络实验通过。
- Phase 1 Gate：A1 完成学习闭环，A2 的成熟 6/7 DOF 系统从 MoveIt 到 controller/Gazebo 可重复运行。
